%######################################################
% A V-cycle Multigrid solver to effciently solve linear systems
%
%
% Last: Created
%
...
%######################################################
function [x,it,res] = VCycleMultigrid(x,b,A,size_row_p1,size_col_p1,delx,dely,epsi,omg,iter1,iter2,L)
...
%----------------------- V-Cycle Multigrid Solver ------------------------%
    ...
    if L < 2
        ...
        x_coarse = VCycleMultigrid(zeros(loc_size,1),res_coarse,A_coarse,size_row_p1,size_col_p1,delx,dely,epsi,omg,iter1,iter2,L+1); 
